...
public class TelaLogin extends javax.swing.JFrame {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (perfil.equals("admin")) {
                    ...
                    principal.setVisible(true);// Abrindo o formulário tela principal
    ...
    public TelaLogin() {
        ...
        //A linha abaixo serve de Status de conexão.
        //System.out.println(conexao);
        if (conexao != null) {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infow/icones/dbok.png")));
        } else {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infow/icones/dberro.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infow/icones/dberro.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(303, 178));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // BOTÃO LOGIN, CHAMANDO O MÉTODO LOGAR.
        logar();
